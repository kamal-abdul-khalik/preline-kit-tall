...
<div x-data="{
    ...
    <div x-show="show" class="fixed inset-0 transition-all transform" x-on:click="show = false"
        ...
        <div class="absolute inset-0 opacity-75 bg-dark-500 dark:bg-dark-900"></div>
    </div>

    <div x-show="show"
        class="mb-6 bg-white dark:bg-dark-900 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
