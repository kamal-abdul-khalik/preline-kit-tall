...
<section>
    <x-card>
        <x-slot name="header">
            ...
            <x-slot
                name="description">{{ __('Ensure your account is using a long, random password to stay secure.') }}</x-slot>
        </x-slot>
        <x-slot name="content">
            <form wire:submit="updatePassword" class="mt-6 space-y-6">
                ...
                <div>
                    ...
                    <x-input wire:model="password_confirmation" id="update_password_password_confirmation"
                        name="password_confirmation" type="password" class="block w-full mt-1"
